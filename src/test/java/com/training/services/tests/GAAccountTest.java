...
public class GAAccountTest extends BaseTest {
    ...
    public void testGuestAccountWrongAppKey() {
        ...
        Response gaValidationNegativeResponse =
    ...
    public void testGuestAccountInvalidEmail() {
        ...
        softAssert.assertThat(gaValidationNegativeResponse.getErrors().get(0).getDeveloperMessage())
