...
public class CatApiTests2 {
    ...
    public void x() {
        ...
        headerMap2.put(map.get("catAuthenticationHeaderName"), map.get("catAuthenticationHeaderValue"));
        List<com.training.api.Response>  gaValidationResponse =  new RestEngine()
                .getResponsePost("https://api.thecatapi.com/v1/breeds"
                        , headerMap2)
                .as(,com.training.api.Response.class );
        //System.out.println(gaValidationResponse.ge getName());
